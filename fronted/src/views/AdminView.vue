<template>
  <div class="w-full h-screen flex flex-col">
    <nav class="p-5 bg-indigo-600 w-full flex justify-between items-center">
      <div></div>
      <div class="flex">
        <router-link
          to="/admin/dashboard"
          active-class="border-b-4 "
          class="text-white font-bold text-lg mx-3 flex items-center gap-2 fill-white p-2"
          ><svg
      ...
      <button class="bg-white px-4 py-2 rounded-md text-lg font-bold text-indigo-600" @click="logOut">X Cerrar sesion</button>
    </nav>
